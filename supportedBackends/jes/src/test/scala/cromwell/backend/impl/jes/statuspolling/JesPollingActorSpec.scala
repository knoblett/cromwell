...
/**
  ...
  * - Mocks out the methods which actually call out to JES, and allows the callsbacks to be triggered in a testable way
  * - Also wait a **lot** less time before polls!
  */
